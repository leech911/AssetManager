...
<?php
// Begin Table generation
$query="select tblAssetDesc.descID, tblAssetDesc.name, tblAssetDesc.make, tblAssetDesc.model, tblStorageLocations.rack, tblStorageLocations.shelf, count(tblTaggedAssets.descID) as 'tagged qty', tblBROnHand.qty as 'BackRoom qty',
